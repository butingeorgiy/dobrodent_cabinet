...
@section('content')
    ...
    <div class="flex justify-center w-full mt-8 mb-16">
        <button id="showMoreVisitsBtn" class="transition duration-300 text-gray-500 border border-gray-500 rounded-md text-sm px-3 py-1 py-2 sm:px-5 hover:text-white hover:bg-gray-500 focus:outline-none">Показать больше</button>
    </div>
@endsection
