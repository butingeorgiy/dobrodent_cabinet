        ...
        <div class="flex flex-col lg:flex-row px-4">
            ...
            <div class="w-full lg:w-1/3">
                ...
                <label class="flex bg-white px-3 py-1 text-gray-700 rounded-md border border-gray-400">
                    ...
                    <input class="bg-white text-sm sm:text-base focus:outline-none disabled:bg-white" type="date" name="visit_date">
                </label>
                ...
                <label class="flex bg-white px-3 py-1 text-gray-700 rounded-md border border-gray-400">
                    ...
                    <input class="bg-white text-sm sm:text-base focus:outline-none disabled:bg-white" type="time" name="visit_time">
                </label>
            </div>
        </div>
        <hr class="my-4" />
