...
@section('content')
    <div class="w-full mb-4 bg-white shadow-md select-none py-5">
        <p class="px-4 text-xl sm:text-2xl text-gray-400 select-none">Записаться на приём</p>
        <hr class="my-4" />
        <div class="flex flex-col lg:flex-row px-4">
            ...
            <div class="w-full lg:w-1/3">
                ...
                <label class="flex items-center bg-white px-3 py-1 text-gray-700 rounded-md border border-gray-400">
                    ...
                    <input class="bg-white text-sm sm:text-base placeholder-gray-700 focus:outline-none disabled:bg-white" type="date" name="visit_date" placeholder="дд.мм.гггг">
                </label>
                ...
                <label class="flex items-center bg-white px-3 py-1 text-gray-700 rounded-md border border-gray-400">
                    ...
                    <input class="bg-white text-sm sm:text-base placeholder-gray-700 focus:outline-none disabled:bg-white" type="time" name="visit_time" placeholder="--:--">
                </label>
            </div>
        </div>
        <hr class="my-4" />
        <div class="flex flex-col-reverse lg:flex-row px-4">
            <button type="button" class="create-visit-btn lg:mr-4 flex justify-center sm:self-start lg:mr-4 px-4 py-2 border border-indigo-100 bg-indigo-100 text-sm sm:text-base text-white rounded-md transition duration-300 ease select-none hover:bg-indigo-200 hover:border-indigo-200 focus:outline-none">
            ...
            <span class="hidden flex items-center mb-4 lg:mb-0 text-red-500 select-none error-message">
