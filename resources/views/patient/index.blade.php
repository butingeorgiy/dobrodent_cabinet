...
@section('content')
            ...
            <div class="{{ request()->has('q') ? '' : 'hidden' }} absolute left-0 w-full px-4 max-h-64">
                <div class="global-search-container flex flex-col w-full max-h-64 pt-2 bg-white border border-t-0 border-gray-300 rounded-b-md overflow-y-scroll shadow-2xl">
                    ...
                    @foreach($global['doctors'] ?? [] as $doctor)
                        <a href="{{ route('patient-doctor', ['id' => $doctor['id']]) }}" class="global-search-item flex min-h-14 px-4 py-2 hover:bg-gray-50 cursor-pointer">
                    ...
                    @foreach($global['visits'] ?? [] as $visit)
                        <a href="{{ route('patient-visit', ['id' => $visit['id']]) }}" class="global-search-item flex min-h-14 px-4 py-2 hover:bg-gray-50 cursor-pointer">
    ...
    <div class="mb-4 pt-4 bg-white shadow-md select-none">
        ...
        <div class="grid lg:grid-cols-2">
            <a href="{{ route('patient-visits-create') }}" class="flex p-4 hover:bg-gray-50 cursor-pointer">
                <div class="mr-2">
                ...
                <div class="flex flex-col">
                    <p class="mb-2 font-medium text-lg sm:text-xl text-green-light">Онлайн запись в наши клиники</p>
            ...
            <a href="{{ route('patient-visits') }}" class="flex p-4 hover:bg-gray-50 cursor-pointer">
                <div class="mr-2">
                    <svg class="text-green-light w-7" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round"
                              stroke-linejoin="round"
                ...
                <div class="flex flex-col">
                    <p class="mb-2 font-medium text-lg sm:text-xl text-green-light">Отслеживайте все свои визиты</p>
                    <p class="text-sm text-gray-700">
                        Тут будет описание данной возможности, а пока что программист не знает что тут написать.
                        Тут будет описание данной возможности, а пока что программист не знает что тут написать.
                    </p>
            ...
            <a href="{{ route('patient-doctors') }}" class="flex p-4 hover:bg-gray-50 cursor-pointer">
                <div class="mr-2">
                    <svg class="text-green-light w-7" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round"
                              stroke-linejoin="round"
            ...
            <a href="{{ route('patient-medical-card') }}" class="flex p-4 hover:bg-gray-50 cursor-pointer">
                <div class="mr-2">
                    <svg class="text-green-light w-7" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round"
                              stroke-linejoin="round"
                ...
                <div class="flex flex-col">
                    <p class="mb-2 font-medium text-lg sm:text-xl text-green-light">Единая онлайн мед. карта</p>
                    <p class="text-sm text-gray-700">
                        Тут будет описание данной возможности, а пока что программист не знает что тут написать.
                        Тут будет описание данной возможности, а пока что программист не знает что тут написать.
                    </p>
    ...
    <div class="flex flex-col mb-4 pt-4 bg-white shadow-md select-none">
        <p class="mx-4 text-xl sm:text-2xl text-gray-400">Ближайшие визиты</p>
        @if(count($visits) !== 0)
        ...
        @else
            <hr class="my-4" />
            <i class="mb-4 mx-4 text-gray-400">У вас не намечается визитов в ближайшую неделю</i>
        @endif
    </div>
@endsection
