...
@section('content')
    ...
    <div id="patientRegForm" class="flex flex-col pb-10 rounded-xl shadow bg-white overflow-hidden" style="width: 550px">
        ...
        <div class="px-8 mt-14 flex flex-col">
            ...
            @elseif(request()->step === '3')
                <form id="createNewPatientForm" class="flex flex-col" method="POST" action="{{ route('create-patient') }}">
