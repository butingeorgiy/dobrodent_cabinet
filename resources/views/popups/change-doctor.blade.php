<div class="hidden edit-visit-doctor-popup popup-wrapper flex justify-center items-center fixed w-screen h-screen z-50 top-0 left-0 bg-black bg-opacity-50">
    <div class="popup relative mx-4 sm:mx-0 transition-top duration-300 ease-out top-350px py-4 bg-white select-none"
         style="width: 600px">
        <p class="mx-4 text-gray-400 text-xl sm:text-2xl">Изменить врача</p>
        <hr class="my-4"/>
        <div class="mx-4">
            <label class="flex flex-col">
                <select class="edit-visit-doctor-select" data-options="{{ $doctors }}" data-selected="{{ $visit->doctor ? $visit->doctor->id : null }}"></select>
            </label>
            ...
            <button class="save-visit-doctor-btn flex justify-center items-center w-full mt-6 px-4 py-2 bg-green-light text-sm sm:text-base text-white rounded-md transition duration-300 hover:opacity-80 focus:outline-none focus:ring-4 focus:ring-green-light focus:ring-opacity-50">
