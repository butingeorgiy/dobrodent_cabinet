...
@section('content')
    <div class="flex mb-4">
        ...
        <div class="w-full bg-white shadow-md p-4">
            <a href="{{ route('doctor-patients') }}" class="flex items-center rounded-md border border-gray-300 px-3 py-2 sm:px-4 sm:py-3">
                ...
                <input class="w-full text-gray-500 placeholder-gray-500 text-lg sm:text-xl outline-none cursor-pointer" type="text" placeholder="Найти пациента ...">
            </a>
{{--            <div class="px-2 mt-2">--}}
